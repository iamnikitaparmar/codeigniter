                ...
                foreach ($user_data as $row) {
                    ...
                    <tr>
                        ...
                        <td><input type="radio" name="gender" <?= $row['gender'] == "Male" ? "checked" : "" ?> value="Male"><label>Male</label>
                            <input type="radio" name="gender" <?= $row['gender'] == "Female" ? "checked" : "" ?> value="Female"> <label>Female</label>
                        </td>
                    </tr>
                    <tr>
                        <td>Birth Date</td>
                    ...
                    <tr>
                        <td>Address</td>
                        <td>:</td>
                        <td><textarea rows="4" cols="50" name="address" value="<?php echo $row->address;  ?>"></textarea></td>
                    </tr>
                    <tr>
                        <td>State</td>
                        <td>:</td>
                        <td><select name="state">
                                ...
                                <option value="panjab" <?php if ($options == "panjab") echo 'selected="selected"'; ?>>Panjab</option>
                                <option value="kerela" <?php if ($options == "kerela") echo 'selected="selected"'; ?>>Kerela</option>
                            </select></td>
                    </tr>
                ...
                foreach ($fetch_data->result() as $row) {
                    ...
                    <tr>
                        ...
                        <td><a href='user/delete?id=<?php echo $row->user_id; ?>'>Delete</a>
                            <a href='user/update?id=<?php echo $row->user_id; ?>'>Update</a>
                        </td>
                    </tr>
                <?php
            }
